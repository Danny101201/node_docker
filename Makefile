...
watchtower :
	docker run  -v /var/run/docker.sock:/var/run/docker.sock containrrr/watchtower  -e WATCHTOWER_DEBUG==true -e WATCHTOWER_TRACE=true  -e WATCHTOWER_POLL_INTERVAL=40 node-app