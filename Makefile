...
watchtower :
	docker run --rm -v /var/run/docker.sock:/var/run/docker.sock containrrr/watchtower -e WATCHTOWER_CLEANUP=true -e WATCHTOWER_DEBUG==true -e WATCHTOWER_TRACE=true  --run-once node-app